grid = [[8, 02, 22, 97, 38, 15, 0, 40, 0, 75, 04, 05, 07, 78, 52, 12, 50, 77, 91, 8],
...
def findHighestProduct(job):
	highest = 0;

	for x in range(job[0], job[2] + 1):
		for y in range(job[1], job[3] + 1):
			tx = x
			ty = y
			result = 1
			for i in range(4):
